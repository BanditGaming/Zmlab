...
if (zmlab.config.SelectedLanguage == "en") then
	...
	zmlab.language.General_WantedNotify = "Sold Meth!"
	...
	zmlab.language.methbuyer_dropoff_wrongguy = "We expected someone else but thanks we send the cash too $deliverguy"
	-- Meth DropOffPoint
