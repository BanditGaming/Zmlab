...
if (zmlab.config.SelectedLanguage == "tr") then
	...
	zmlab.language.General_WantedNotify = "Meth Satıldı!"
	...
	zmlab.language.methbuyer_dropoff_wrongguy = "Baska birisini bekliyorduk parayi $deliverguy kisisine yolluyoruz."
	-- Meth DropOffPoint
